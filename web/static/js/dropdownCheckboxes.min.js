(function($){var dropdownMethods={init:function(options){$(this).find(".dropdown-menu li").click(function(e){e.stopPropagation()});
var dropdowns=$(this);dropdowns.each(function(i){var dropdown=$(this);dropdown.addClass("dropdownCheckboxes");
